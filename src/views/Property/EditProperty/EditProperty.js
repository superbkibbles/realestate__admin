...
const NewProperty = ({history, match}) => {
    ...
    const getProperty = async () => {
        const {data, ok, problem} = await propertyApi.getPropertiesById(match.params.propertyID)
    ...
    const uploadMainPic = async () => {
        if (mainPic) {
            const {data, ok} = await propertyApi.uploadMainPic(property.id, mainPic);
    ...
    const onDeleteSaved = async (visual) => {
        ...
        const {
            data,
            ok
        } = await propertyApi.deleteMedia(property.id, fileName);
        if (!ok) return console.log(data)
        else {
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        <CardBody>
                                            <GridContainer>
                                                ...
                                                <GridItem xs={12} sm={12} md={6}>
                                                    <Autocomplete
                                                        ...
                                                        onChange={(e, v) => v ? setFieldValue('agency_id', v.id) : setFieldValue('agency_id', null)}
                                                        renderInput={(params) =>
                                                ...
                                                <GridItem xs={12} sm={12} md={6}>
                                                    <Autocomplete
                                                        ...
                                                        onChange={(e, v) => v ? setFieldValue('complex_id', v.id) : setFieldValue('complex_id', null)}
                                                        renderInput={(params) =>
                                            ...
                                            <GridContainer>
                                                ...
                                                {
                                                    property.visuals && property.visuals.map(visual => {
                                                ...
                                                {property.videos && property.videos.map(visual => (
                                                    <GridItem xs={12} sm={12} md={4}>
                                                        <div style={{position: 'relative'}}>
                                                            <Delete
                                                                onClick={() => onDeleteSaved(visual)}
                                        ...
                                        <CardFooter>
                                            <Button round color="primary" onClick={handleSubmit}>Save
                                                Changes</Button>
